...
window.LEISTUNG_DATA = {
  ...
  "endodontologie": {
    ...
    intro: {
      ...
      body: "Eine Wurzelentzündung entsteht meist durch tiefe Karies oder Verletzungen. Das Innere des Zahns, Nerv und Blutgefäße, entzündet sich. Die einzige Alternative zur Wurzelbehandlung ist das Ziehen des Zahns.\n\nMit modernen, maschinell-gestützten Verfahren erhalten wir den Zahn in den allermeisten Fällen. Sie behalten Ihren eigenen, fest verwurzelten Zahn, eine Leistung, die kein Zahnersatz vollständig ersetzen kann."
    },
    inclusions: [
      { title: "Diagnose mit moderner Bildgebung", desc: "Digitales Röntgen für präzise Diagnostik." },
      { title: "Behandlung unter lokaler Betäubung", desc: "Sie spüren während der Behandlung nichts." },
      { title: "Maschinelle Wurzelkanal-Aufbereitung", desc: "Mit feinen Nickel-Titan-Instrumenten und elektrometrischer Längenmessung." },
    ...
    process: [
      ...
      { num: "04", title: "Wurzelfüllung", desc: "Bakteriendichte Versiegelung, in der gleichen oder einer Folge-Sitzung." },
  ...
  "aesthetik-funktion": {
    ...
    intro: {
      ...
      body: "Wir korrigieren mit Veneers, Kronen oder Composite-Bonding, immer im Einklang mit Ihrem Biss, Ihrer Sprache und Ihrer natürlichen Mimik. Schöne Zähne, die nicht funktionieren, sind keine Lösung.\n\nVor jeder Behandlung erörtern wir das gewünschte Ergebnis gemeinsam. Sie entscheiden mit. Auf Wunsch mit analoger oder digitaler Vorab-Visualisierung."
    },
    inclusions: [
      { title: "Beratung und gemeinsame Zielplanung", desc: "Wir besprechen Ihr gewünschtes Ergebnis, auf Wunsch mit analoger oder digitaler Vorab-Visualisierung." },
    ...
    process: [
      ...
      { num: "02", title: "Mock-up", desc: "Auf Wunsch ein Probe-Lächeln direkt auf den Zähnen, ohne Bohren." },
      { num: "03", title: "Behandlung", desc: "Schonende Vorbereitung der Zähne und Eingliederung der Versorgung." },
      { num: "04", title: "Feinanpassung", desc: "Wir kontrollieren Biss und Optik, bis es perfekt sitzt." }
    ],
    faqs: [
  ...
  "implantologie": {
    ...
    process: [
      ...
      { num: "04", title: "Freilegung des Implantats", desc: "Kleiner Eingriff zur Freilegung des eingeheilten Implantats und Einsetzen des Aufbaus." },
      { num: "05", title: "Eingliederung der Krone", desc: "Anfertigung und Befestigung der individuellen Krone, keine Schmerzen." },
      { num: "06", title: "Recall und Nachsorge", desc: "Lebenslange engmaschige Betreuung schützt Ihre Investition." }
    ],
    faqs: [
  ...
  "oralchirurgie": {
    ...
    meta: [
      ...
      { label: "Betäubung", value: "Lokal/Sedierung" }
    ],
    intro: {
    ...
    inclusions: [
      { title: "Digitale Röntgenaufnahmen", desc: "Vor jedem komplexen Eingriff erstellen wir digitale Röntgenaufnahmen zur Planung." },
      { title: "Schonende Technik", desc: "Mikrochirurgische Instrumente, kleinste Schnitte, atraumatisches Vorgehen." },
      { title: "Effektive Betäubung", desc: "Lokale Betäubung, auf Wunsch mit leichter Sedierung." },
    ...
    faqs: [
      ...
      { q: "Was ist mit Vollnarkose?", a: "Für Vollnarkose haben wir kompetente chirurgische Partner-Praxen, wir helfen gerne bei der Vermittlung." }
    ]
  },
  "schienentherapie": {
    ...
    meta: [
      ...
      { label: "Kosten", value: "Kassenleistung mit Zuzahlung" },
    ...
    faqs: [
      ...
      { q: "Übernimmt die Krankenkasse die Kosten?", a: "Eine Knirsch-Schiene ist Kassenleistung mit Zuzahlung. Der Eigenanteil beträgt ca. 50–250 Euro, je nach Schienentyp." }
    ]
  },
  "schnarchschienen": {
    parent: { label: "Schienentherapie", anchor: "schienen" },
    ...
    process: [
      ...
      { num: "02", title: "Schlafdiagnostik (optional)", desc: "Optional, aber zwingend für Kostenübernahme durch GKV. Ausschluss von Schlafapnoe in Zusammenarbeit mit Schlaflabor." },
  ...
  "zahnkorrektur-schienen": {
    ...
    faqs: [
      ...
      { q: "Was kostet die Behandlung?", a: "Je nach Komplexität ab ca. 1.500–2.000 € pro Kiefer. Wir erstellen einen individuellen Plan." }
    ]
  },
  "kinderzahnheilkunde": {
  ...
  "zahnarztangst": {
    ...
    meta: [
      ...
      { label: "Kosten", value: "Kassenleistung" },
      { label: "Sedierung", value: "Auf Wunsch" }
    ],
    intro: {
    ...
    faqs: [
      ...
      { q: "Können Sie mich auch in Vollnarkose behandeln?", a: "In unserer Praxis nicht, wir helfen aber gerne weiter. Wir vermitteln an kompetente Partner-Praxen für Vollnarkose-Behandlungen." },
